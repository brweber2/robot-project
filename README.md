...
You do not need the specific tools linked, I've just included them for convenience.

* 3D Printer [FLASHFORGE Adventurer 5M](https://www.amazon.com/dp/B0CPSZ9PGS)
* PLA Filament [Rapid PLA Filament 1.75mm Ruby Red](https://www.amazon.com/dp/B0CB7TW3XC)
* Screwdriver [JOREST Precision Screwdriver Set](https://www.amazon.com/dp/B0D2HGJFL2)
* Heat Gun [SEEKONE Heat Gun](https://www.amazon.com/dp/B086WH19WH)
* Soldering Iron [Soldering Iron](https://www.amazon.com/gp/product/B0BX2N258S)
* M5 Hex Wrench [M5 Hex Wrench is 4mm](https://www.amazon.com/Amazon-Basics-Wrench-Standard-26-Piece/dp/B0776C2D6H)
* Soldering Mat [Soldering Mat](https://www.amazon.com/Kaisi-Insulation-Soldering-Maintenance-Electronics/dp/B073RFB6BX)

### Chassis

Much of this is from [Hugging Face's Lerobot](https://huggingface.co/docs/lerobot/lekiwi)

#### Non-3D Printed Parts

* Motor (3 total) [12V 37mm Motor](https://www.amazon.com/dp/B08D3SSG55)
* AWG Plug Connector [AWG Plug Connector](https://www.amazon.com/dp/B06XRBKSY2)
* Wire Heat Shrink Tubing [Wire Heat Shrink Tubing](https://www.amazon.com/dp/B0BG6V4HV4)
* Microcontroller
  * Coming soon

#### 3D Printed Parts

* Base Plate (2 total) [Base Plate](3d_prints/chassis/base_plate_layer2.stl) 
  * Source: [LeKiwi Base Plate](https://github.com/SIGRobotics-UIUC/LeKiwi/blob/main/3DPrintMeshes/base_plate_layer2.stl)
* Motor Mount (3 total) [Motor Mount](3d_prints/chassis/Marcin-61-JGB37-3650_holder.3mf) 
  * Source: [Motor Mount](https://openroboticplatform.com/part:61)
